...
export const routeMeta = {
  ...
  '/admin/accounts': meta('账号管理', '管理业务账户、额度、来源与分组归属。'),
  ...
  '/keys': meta('API 密钥', '管理当前业务账户的 API 密钥。'),
  '/usage': meta('使用记录', '查看当前业务账户的请求、缓存和消费明细。'),
  '/available-channels': meta('可用渠道', '查看当前账户能使用的计划、分组和通道范围。'),
  '/monitor': meta('渠道状态', '查看当前账户可见线路和渠道状态。'),
  '/subscriptions': meta('我的订阅', '查看当前账户订阅状态、额度和到期时间。'),
  '/purchase': meta('充值/订阅', '创建订单并购买当前账户可用的订阅计划。'),
  '/orders': meta('我的订单', '查看当前账户的订单和履约结果。'),
  '/redeem': meta('兑换', '面向当前账户的兑换入口。'),
  '/affiliate': meta('邀请返利', '面向当前账户的邀请返利入口。'),
  '/profile': meta('个人资料', '面向当前账户的资料与归属信息页。'),
