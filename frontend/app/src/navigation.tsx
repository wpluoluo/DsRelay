...
export const routeMeta = {
  ...
  '/admin/announcements': meta('公告', ''),
  '/admin/proxies': meta('代理', ''),
  '/admin/risk-control': meta('风控', ''),
  '/admin/redeem': meta('兑换码', ''),
  '/admin/promo-codes': meta('Promo Codes', ''),
  '/admin/affiliates/invites': meta('邀请记录', ''),
  '/admin/affiliates/rebates': meta('返利记录', ''),
  '/admin/affiliates/transfers': meta('提取记录', ''),
  '/admin/orders/dashboard': meta('支付概览', ''),
  '/admin/orders': meta('订单管理', ''),
  '/admin/orders/plans': meta('订阅套餐', ''),
  '/admin/usage': meta('使用记录', ''),
  '/admin/settings': meta('系统设置', ''),
  '/keys': meta('API 密钥', ''),
  '/usage': meta('使用记录', ''),
  '/available-channels': meta('可用渠道', ''),
  '/monitor': meta('渠道状态', ''),
  '/subscriptions': meta('我的订阅', ''),
  '/purchase': meta('充值/订阅', ''),
  '/orders': meta('我的订单', ''),
  '/redeem': meta('兑换', ''),
  '/affiliate': meta('邀请返利', ''),
